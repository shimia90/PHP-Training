...
<div class="panel-body table-responsive margin-t-20 margin-b-20">
    ...
    <p><a href="<?php echo URL::createLink('default', 'user', 'index'); ?>" class="btn btn-primary"><i class="fa fa-backward"></i> Go Back</a></p>
</div>
<!-- END CONTAINER -->
 <!-- //////////////////////////////////////////////////////////////////////////// --> 
...
<?php
	...
	URL::redirect(URL::createLink('default', 'user', 'index'));	
}
?>