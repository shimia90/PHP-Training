<?php 
	...
	// SELECT GROUP ACP
	$selectGroup      =   Helper::cmsSelectBox('filter_group_id', 'inputbox', $this->slbGroup, @$this->arrayParams['filter_group_id']);
		...
		<form action="#" method="post" name="adminForm" id="adminForm">
			...
			<fieldset id="filter-bar">
				...
				<div class="filter-select fltrt">
					<?php echo $selectBoxStatus . $selectGroup; ?>
				</div>
			</fieldset>
			<div class="clr"></div>
			...
			<table class="adminlist" id="modules-mgr">
				...
				<thead>
					<tr>
						...
						<th class="10%"><?php echo $lblEmail; ?></th>
						<th class="10%"><?php echo $lblFullName; ?></th>
						<th class="10%"><?php echo $lblGroup; ?></th>
